...
public final class SignalServiceContent {
  ...
  private static SignalServiceDataMessage.Payment createPayment(SignalServiceProtos.DataMessage content) throws InvalidMessageException {
    ...
    switch (payment.getItemCase()) {
      ...
      default:
        throw new InvalidMessageException("Unknown payment item");
    }
  }
  ...
  private static SignalServiceGroup createGroupV1Info(SignalServiceProtos.DataMessage content) throws ProtocolInvalidMessageException {
    ...
    switch (content.getGroup().getType()) {
      case DELIVER:
        type = SignalServiceGroup.Type.DELIVER; break;
      case UPDATE:
        type = SignalServiceGroup.Type.UPDATE; break;
      case QUIT:
        type = SignalServiceGroup.Type.QUIT; break;
      case REQUEST_INFO:
        type = SignalServiceGroup.Type.REQUEST_INFO; break;
      default:
        type = SignalServiceGroup.Type.UNKNOWN; break;
    }
