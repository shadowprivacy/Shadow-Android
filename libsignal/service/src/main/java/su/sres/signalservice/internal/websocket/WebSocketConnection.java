...
import su.sres.signalservice.api.websocket.HealthMonitor;
...
import static su.sres.signalservice.internal.websocket.WebSocketProtos.WebSocketMessage;
...
public class WebSocketConnection extends WebSocketListener {
                             ...
                             HealthMonitor healthMonitor)
  {
    ...
    this.shadowProxy         = serviceConfiguration.getShadowProxy();
  ...
  public synchronized Observable<WebSocketConnectionState> connect() {
    ...
    if (client == null) {
      ...
      if (credentialsProvider.isPresent()) {
        String identifier = credentialsProvider.get().getUuid() != null ? credentialsProvider.get().getUuid().toString() : credentialsProvider.get().getUserLogin();
