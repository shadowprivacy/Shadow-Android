...
import su.sres.securesms.util.testprotos.TestInnerMessage;
import su.sres.securesms.util.testprotos.TestInnerMessageWithNewString;
import su.sres.securesms.util.testprotos.TestPerson;
import su.sres.securesms.util.testprotos.TestPersonWithNewFieldOnMessage;
import su.sres.securesms.util.testprotos.TestPersonWithNewMessage;
import su.sres.securesms.util.testprotos.TestPersonWithNewRepeatedString;
import su.sres.securesms.util.testprotos.TestPersonWithNewString;
import su.sres.securesms.util.testprotos.TestPersonWithNewStringAndInt;
