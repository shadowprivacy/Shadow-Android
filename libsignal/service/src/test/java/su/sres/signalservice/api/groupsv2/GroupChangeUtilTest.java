...
public final class GroupChangeUtilTest {
     ...
     * <p>
     * If we didn't, newly added fields would easily affect {@link su.sres.signalservice.api.groupsv2.GroupChangeUtil}'s ability to detect empty change states and resolve conflicts.
     */
    @Test
    ...
    public void empty_change_set() {
        assertTrue(su.sres.signalservice.api.groupsv2.GroupChangeUtil.changeIsEmpty(GroupChange.Actions.newBuilder().build()));
    }
    ...
    public void not_empty_with_add_member_field_3() {
        ...
        assertFalse(su.sres.signalservice.api.groupsv2.GroupChangeUtil.changeIsEmpty(actions));
    }
