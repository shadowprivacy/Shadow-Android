...
import static su.sres.securesms.webrtc.CameraState.Direction.BACK;
import static su.sres.securesms.webrtc.CameraState.Direction.FRONT;
import static su.sres.securesms.webrtc.CameraState.Direction.NONE;
import static su.sres.securesms.webrtc.CameraState.Direction.PENDING;

public class PeerConnectionWrapper {
  private static final String TAG = PeerConnectionWrapper.class.getSimpleName();

  private static final PeerConnection.IceServer STUN_SERVER = new PeerConnection.IceServer("stun:example.org:3478");
