    ...
    public void androidLogUsed_LogNotShadow_2_args() {
        lint()
                ...
                .expect("src/foo/Example.java:5: Error: Using 'android.util.Log' instead of a Shadow Logger [LogNotShadow]\n" +
                        ...
                        "    ~~~~~~~~~~~~~~~~~~~\n" +
                        "1 errors, 0 warnings")
                .expectFixDiffs("Fix for src/foo/Example.java line 5: Replace with su.sres.securesms.logging.Log.d(\"TAG\", \"msg\"):\n" +
                        "@@ -5 +5\n" +
                        "-     Log.d(\"TAG\", \"msg\");\n" +
                        "+     su.sres.securesms.logging.Log.d(\"TAG\", \"msg\");");
    }
    ...
    public void androidLogUsed_LogNotShadow_3_args() {
        lint()
                ...
                .expect("src/foo/Example.java:5: Error: Using 'android.util.Log' instead of a Shadow Logger [LogNotShadow]\n" +
                        ...
                        "    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n" +
                        "1 errors, 0 warnings")
                .expectFixDiffs("Fix for src/foo/Example.java line 5: Replace with su.sres.securesms.logging.Log.w(\"TAG\", \"msg\", new Exception()):\n" +
                        "@@ -5 +5\n" +
                        "-     Log.w(\"TAG\", \"msg\", new Exception());\n" +
                        "+     su.sres.securesms.logging.Log.w(\"TAG\", \"msg\", new Exception());");
    }
