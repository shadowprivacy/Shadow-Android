...
public final class ShadowLogDetector extends Detector implements Detector.UastScanner {

    static final Issue LOG_NOT_SHADOW = Issue.create("LogNotShadow",
            "Logging call to Android Log instead of Shadow's Logger",
            "Shadow has its own logger which must be used.",
            Category.MESSAGES,
            5,
            Severity.ERROR,
            new Implementation(ShadowLogDetector.class, Scope.JAVA_FILE_SCOPE));
