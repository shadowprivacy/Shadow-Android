...
class RecipientDatabaseTest {
  ...
  fun getAndPossiblyMerge_e164MapsToExistingUserButAciDoesNot_aciAndE164_highTrust() {
    val existingId: RecipientId = recipientDatabase.getOrInsertFromUserLogin(E164_A)
  ...
  fun getAndPossiblyMerge_bothAciAndE164MapToExistingUser_aciAndE164_merge_highTrust() {
    ...
    val existingE164Id: RecipientId = recipientDatabase.getOrInsertFromUserLogin(E164_A)
  ...
  fun createByE164SanityCheck() {
    // GIVEN one recipient
    val recipientId: RecipientId = recipientDatabase.getOrInsertFromUserLogin(E164_A)
