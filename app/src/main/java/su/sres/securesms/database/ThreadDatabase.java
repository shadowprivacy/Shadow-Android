...
public class ThreadDatabase extends Database {
    ...
    public @NonNull
    Set<RecipientId> getArchivedRecipients() {
    ...
    public @NonNull
    Map<RecipientId, Integer> getInboxPositions() {
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
...
//      StorageSyncHelper.scheduleSyncForDataChange();
    ...
    public @Nullable
    Long getThreadIdFor(@NonNull RecipientId recipientId) {
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
        String where = RECIPIENT_ID + " = ?";
        String[] recipientsArg = new String[]{recipientId.serialize()};
    ...
    public @Nullable
    RecipientId getRecipientIdForThreadId(long threadId) {
        SQLiteDatabase db = databaseHelper.getReadableDatabase();
  ...
  /* @NonNull MergeResult merge(@NonNull RecipientId primaryRecipientId, @NonNull RecipientId secondaryRecipientId) {
    ...
    private @Nullable
    String getContentTypeFor(MessageRecord record) {
        if (record.isMms()) {
    ...
    private @Nullable
    Extra getExtrasFor(MessageRecord record) {
    ...
    private @NonNull
    String createQuery(@NonNull String where, long offset, long limit, boolean preferPinned) {
    ...
    private @NonNull
    String createQuery(@NonNull String where, @NonNull String orderBy, long offset, long limit, boolean preferPinned) {
    ...
    public static final class Extra {
        ...
        public static @NonNull
        Extra forSticker(@Nullable String emoji) {
