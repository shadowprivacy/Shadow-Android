...
public class MediaDatabase extends Database {
  ...
  MediaDatabase(Context context, ShadowDatabase databaseHelper) {
    super(context, databaseHelper);
  }

  public @NonNull
  Cursor getGalleryMediaForThread(long threadId, @NonNull Sorting sorting) {
  ...
  public @NonNull
  Cursor getDocumentMediaForThread(long threadId, @NonNull Sorting sorting) {
    SQLiteDatabase database = databaseHelper.getSignalReadableDatabase();
  ...
  public @NonNull
  Cursor getAudioMediaForThread(long threadId, @NonNull Sorting sorting) {
    SQLiteDatabase database = databaseHelper.getSignalReadableDatabase();
  ...
  public @NonNull
  Cursor getAllMediaForThread(long threadId, @NonNull Sorting sorting) {
    SQLiteDatabase database = databaseHelper.getSignalReadableDatabase();
  ...
  public static class MediaRecord {
    ...
    public @NonNull
    RecipientId getThreadRecipientId() {
