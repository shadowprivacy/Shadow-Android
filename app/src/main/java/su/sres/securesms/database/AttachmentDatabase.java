...
public class AttachmentDatabase extends Database {
  ...
  public AttachmentDatabase(Context context, ShadowDatabase databaseHelper, AttachmentSecret attachmentSecret) {
    super(context, databaseHelper);
    this.attachmentSecret = attachmentSecret;
  }

  public @NonNull
  InputStream getAttachmentStream(AttachmentId attachmentId, long offset)
      throws IOException
  {
      ...
      throws MmsException
  {
    ...
    notifyConversationListeners(ShadowDatabase.mms().getThreadIdForMessage(mmsId));
  }
  ...
  public @NonNull
  List<DatabaseAttachment> getAttachmentsForMessage(long mmsId) {
    SQLiteDatabase           database = databaseHelper.getSignalReadableDatabase();
  ...
  public @NonNull
  List<DatabaseAttachment> getPendingAttachments() {
  ...
  public void deleteAttachmentFilesForViewOnceMessage(long mmsId) {
    ...
    long threadId = ShadowDatabase.mms().getThreadIdForMessage(mmsId);
    if (threadId > 0) {
  ...
  public int deleteAbandonedAttachmentFiles() {
    ...
    filesInDb.addAll(ShadowDatabase.stickers().getAllStickerFiles());
  ...
  private @NonNull
  DataUsageResult getAttachmentFileUsages(@Nullable String data, @NonNull AttachmentId attachmentId) {
      ...
      throws MmsException
  {
    ...
    if (database.update(TABLE_NAME, values, PART_ID_WHERE, attachmentId.toStrings()) == 0) {
      ...
      long threadId = ShadowDatabase.mms().getThreadIdForMessage(mmsId);
      ShadowDatabase.threads().updateSnippetUriSilently(threadId, PartAuthority.getAttachmentDataUri(attachmentId));
  ...
  String getVisualHashStringOrNull(@Nullable Attachment attachment) {
  ...
  public @NonNull
  DatabaseAttachment insertAttachmentForPreUpload(@NonNull Attachment attachment) throws MmsException {
  ...
  @NonNull
  Map<Attachment, AttachmentId> insertAttachmentsForMessage(long mmsId, @NonNull List<Attachment> attachments, @NonNull List<Attachment> quoteAttachment)
      throws MmsException
  {
  ...
  public @NonNull
  File getOrCreateTransferFile(@NonNull AttachmentId attachmentId) throws IOException {
    SQLiteDatabase db       = databaseHelper.getSignalWritableDatabase();
  ...
  private @Nullable
  static File getTransferFile(@NonNull SQLiteDatabase db, @NonNull AttachmentId attachmentId) {
  ...
  public void markAttachmentUploaded(long messageId, Attachment attachment) {
    ...
    notifyConversationListeners(ShadowDatabase.mms().getThreadIdForMessage(messageId));
  }
   ...
   */
  public @Nullable
  Cursor getUnavailableStickerPacks() {
  ...
  @VisibleForTesting
  protected @Nullable
  InputStream getDataStream(AttachmentId attachmentId, String dataType, long offset) {
  ...
  private @Nullable
  DataInfo getAttachmentDataFileInfo(@NonNull AttachmentId attachmentId, @NonNull String dataType) {
    SQLiteDatabase database = databaseHelper.getSignalReadableDatabase();
    Cursor         cursor   = null;
  ...
  private @NonNull
  DataInfo setAttachmentData(@NonNull Uri uri,
  ...
  private @NonNull
  DataInfo setAttachmentData(@NonNull InputStream in,
                             @Nullable AttachmentId attachmentId)
      throws MmsException
  {
    try {
  ...
  private @NonNull
  DataInfo setAttachmentData(@NonNull File destination,
  ...
  Optional<DataInfo> findDuplicateDataFileInfo(@NonNull SQLiteDatabase database,
                                               @NonNull String hash,
  ...
  private @Nullable
  DatabaseAttachment findTemplateAttachment(@NonNull String dataHash) {
  ...
  @RequiresApi(23)
  public @Nullable
  MediaDataSource mediaDataSourceFor(@NonNull AttachmentId attachmentId) {
    DataInfo dataInfo = getAttachmentDataFileInfo(attachmentId, DATA);
  ...
  public static final class TransformProperties {
    ...
    public static @NonNull
    TransformProperties forSkipTransform() {
      return new TransformProperties(true, false, 0, 0, DEFAULT_MEDIA_QUALITY);
    }

    public static @NonNull
    TransformProperties forVideoTrim(long videoTrimStartTimeUs, long videoTrimEndTimeUs) {
    ...
    static @NonNull
    TransformProperties parse(@Nullable String serialized) {
      if (serialized == null) {
        return empty();
      }
