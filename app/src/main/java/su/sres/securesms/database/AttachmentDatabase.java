...
public class AttachmentDatabase extends Database {
    ...
    public @NonNull
    InputStream getThumbnailStream(@NonNull AttachmentId attachmentId)
            throws IOException {
    ...
    String getBlurHashStringOrNull(@Nullable BlurHash blurHash) {
    ...
    DataInfo getAttachmentDataFileInfo(@NonNull AttachmentId attachmentId, @NonNull String dataType) {
        ...
        switch (dataType) {
            case DATA:
                randomColumn = DATA_RANDOM;
                break;
            case THUMBNAIL:
                randomColumn = THUMBNAIL_RANDOM;
                break;
            default:
