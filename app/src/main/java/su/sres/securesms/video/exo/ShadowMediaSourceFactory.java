...
/**
 * This class is responsible for creating a MediaSource object for a given Uri, using {@link ShadowDataSource.Factory}.
 */
@SuppressWarnings("deprecation")
public final class ShadowMediaSourceFactory implements MediaSourceFactory {

  private final ProgressiveMediaSource.Factory progressiveMediaSourceFactory;

  public ShadowMediaSourceFactory(@NonNull Context context) {
    DataSource.Factory attachmentDataSourceFactory = new ShadowDataSource.Factory(context, null, null);
