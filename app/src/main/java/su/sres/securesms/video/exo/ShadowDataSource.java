...
public class ShadowDataSource implements DataSource {
  ...
  public ShadowDataSource(@NonNull DefaultDataSource defaultDataSource,
  ...
  public static final class Factory implements DataSource.Factory {
    ...
    @Override
    public @NonNull ShadowDataSource createDataSource() {
      return new ShadowDataSource(new DefaultDataSourceFactory(context, "GenericUserAgent", null).createDataSource(),
