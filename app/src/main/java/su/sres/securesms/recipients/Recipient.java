...
import su.sres.securesms.contacts.avatars.GroupRecordContactPhoto;
...
public class Recipient {
  ...
  private final Capability             changeLoginCapability;
   ...
   * the database if necessary. The identifier may be a aci, phone number, email,
...
//      String e164 = PhoneNumberFormatter.get(context).format(identifier);
  ...
  Recipient(@NonNull RecipientId id) {
    ...
    this.changeLoginCapability       = Capability.UNKNOWN;
    this.storageId                   = null;
  ...
  public Recipient(@NonNull RecipientId id, @NonNull RecipientDetails details, boolean resolved) {
    ...
    this.changeLoginCapability       = details.changeLoginCapability;
   ...
   * available, will return a user login.
   */
  ...
  public @NonNull Capability getChangeLoginCapability() {
