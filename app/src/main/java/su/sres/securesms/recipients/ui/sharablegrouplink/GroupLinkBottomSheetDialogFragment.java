...
import su.sres.securesms.recipients.ui.sharablegrouplink.qr.GroupLinkShareQrDialogFragment;
...
public final class GroupLinkBottomSheetDialogFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View     shareViaShadowButton = view.findViewById(R.id.group_link_bottom_sheet_share_via_signal_button);
        ...
        liveGroup.getGroupLink().observe(getViewLifecycleOwner(), groupLink -> {
            ...
            shareViaShadowButton.setOnClickListener(v -> {
