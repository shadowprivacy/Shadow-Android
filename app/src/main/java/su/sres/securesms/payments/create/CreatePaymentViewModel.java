...
public class CreatePaymentViewModel extends ViewModel {
    ...
    @NonNull
    LiveData<InputState> getInputState() {
        return inputState.getStateLiveData();
    }

    @NonNull
    LiveData<Boolean> getIsPaymentsSupportedByPayee() {
        return isPaymentsSupportedByPayee;
    }

    @NonNull
    LiveData<CharSequence> getNote() {
        return Transformations.distinctUntilChanged(note);
    }

    @NonNull
    LiveData<Boolean> isValidAmount() {
        return isValidAmount;
    }

    @NonNull
    LiveData<Boolean> getCanSendPayment() {
        return isValidAmount;
    }

    @NonNull
    LiveData<Money> getSpendableBalance() {
