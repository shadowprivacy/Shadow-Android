...
public class DirectoryHelper {
  ...
  public static void refreshDirectory(@NonNull Context context) throws IOException {
    ...
    if (TextUtils.isEmpty(SignalStore.account().getUserLogin())) {
      Log.w(TAG, "Have not yet set our own local login. Skipping.");
      return;
    }
    ...
    final RecipientDatabase           recipientDatabase = ShadowDatabase.recipients();
