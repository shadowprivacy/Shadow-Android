...
import su.sres.securesms.stickers.StickerKeyboardPageFragment.EventListener;
...
/**
 * A provider to select stickers in the {@link su.sres.securesms.components.emoji.MediaKeyboard}.
 */
