...
final class GroupManagerV2 {
  ...
  final class GroupEditor extends LockOwner {
        ...
        throws GroupChangeFailedException, GroupNotAMemberException, GroupInsufficientRightsException, IOException
    {
      ...
      switch (state) {
        case DISABLED:
          access = AccessControl.AccessRequired.UNSATISFIABLE; break;
        case ENABLED:
          access = AccessControl.AccessRequired.ANY; break;
        case ENABLED_WITH_APPROVAL:
          access = AccessControl.AccessRequired.ADMINISTRATOR; break;
        default:
