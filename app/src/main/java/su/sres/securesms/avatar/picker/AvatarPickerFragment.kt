...
import su.sres.securesms.avatar.photo.PhotoEditorFragment
import su.sres.securesms.avatar.text.TextAvatarCreationFragment
import su.sres.securesms.avatar.vector.VectorAvatarCreationFragment
import su.sres.securesms.components.ButtonStripItemView
...
class AvatarPickerFragment : Fragment(R.layout.avatar_picker_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_SELECT_AVATAR = "su.sres.securesms.avatar.picker.SELECT_AVATAR"
    const val SELECT_AVATAR_MEDIA = "su.sres.securesms.avatar.picker.SELECT_AVATAR_MEDIA"
    const val SELECT_AVATAR_CLEAR = "su.sres.securesms.avatar.picker.SELECT_AVATAR_CLEAR"
