...
public class TextSecurePreferences {
  ...
  /**
   * @deprecated Use {@link SettingsValues#getMessageFontSize()} via {@link su.sres.securesms.keyvalue.SignalStore} instead.
   */
  ...
  /**
   * @deprecated Use {@link SettingsValues#getLanguage()} via {@link su.sres.securesms.keyvalue.SignalStore} instead.
   */
  ...
  /**
   * @deprecated Use {@link SettingsValues#setLanguage(String)} via {@link su.sres.securesms.keyvalue.SignalStore} instead.
   */
  ...
  private static void clearLocalCredentials(Context context) {
    ...
    ShadowDatabase.recipients().setProfileKey(self.getId(), newProfileKey);
