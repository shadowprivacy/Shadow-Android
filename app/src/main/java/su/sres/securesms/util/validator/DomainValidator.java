 ...
 */
package su.sres.securesms.util.validator;
...
//        "mcd", // mcd McDonaldâ€™s Corporation (Not assigned)
//        "mcdonalds", // mcdonalds McDonaldâ€™s Corporation (Not assigned)
...
//        "warman", // warman Weir Group IP Limited
            ...
            "xn--cckwcxetd", // ã‚¢ãƒžã‚¾ãƒ³ Amazon Registry Services, Inc.
...
//        "xn--estv75g", // å·¥è¡Œ Industrial and Commercial Bank of China Limited
            ...
            "xn--jlq480n2rg", // äºšé©¬é€Š Amazon Registry Services, Inc.
            ...
            "xn--mgbaakc7dvf", // Ø§ØªØµØ§Ù„Ø§Øª Emirates Telecommunications Corporation (trading as Etisalat)
...
//        "xn--mgbb9fbpob", // Ù…ÙˆØ¨Ø§ÙŠÙ„ÙŠ GreenTech Consultancy Company W.L.L.
            ...
            "xn--ngbrx", // Ø¹Ø±Ø¨ League of Arab States
...
//        "tp",                 // East Timor (Retired)
            ...
            "xn--mgbah1a3hjkrd", // Ù…ÙˆØ±ÙŠØªØ§Ù†ÙŠØ§ UniversitÃ© de Nouakchott Al Aasriya
            "xn--mgbai9azgqp6j", // Ù¾Ø§Ú©Ø³ØªØ§Ù† National Telecommunication Corporation
            "xn--mgbayh7gpa", // Ø§Ù„Ø§Ø±Ø¯Ù† National Information Technology Center (NITC)
            "xn--mgbbh1a", // Ø¨Ø§Ø±Øª National Internet eXchange of India
            ...
            "xn--mgbcpq6gpa1a", // Ø§Ù„Ø¨Ø­Ø±ÙŠÙ† Telecommunications Regulatory Authority (TRA)
            "xn--mgberp4a5d4ar", // Ø§Ù„Ø³Ø¹ÙˆØ¯ÙŠØ© Communications and Information Technology Commission
            "xn--mgbgu82a", // Ú€Ø§Ø±Øª National Internet eXchange of India
            ...
            "xn--q7ce6a", // àº¥àº²àº§ Lao National Internet Center (LANIC)
            "xn--qxa6a", // ÎµÏ… EURid vzw/asbl
